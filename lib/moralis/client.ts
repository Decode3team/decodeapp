...
class MoralisDiscoveryApi {
  async getRisingLiquidityTokens(params: RisingLiquidityTokenParams) {
    const requestUrl =
      "https://deep-index.moralis.io/api/v2.2/discovery/tokens/rising-liquidity?chain=eth&one_month_liquidity_change_usd=500000&min_market_cap=100000000&twitter_followers=10000&one_month_volume_change_usd=10000&security_score=70&one_month_price_percent_change_usd=0'";
