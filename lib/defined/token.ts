...
export class DefinedApiTokenClient {
    ...
    async getTopTokens(resolution: DefinedApiTimeResolution = "60") {
        ...
        return this.client.query<DefinedTopTokenModel[]>(queryName, `
            query {
                ${queryName}(
            ...
            await this.redisClient.set(CacheKeys.TOP_TOKEN[resolution], JSON.stringify(res), TimeResolution[resolution]);
            return res;
        });
    }
}